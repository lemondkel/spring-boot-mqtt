package lemonfree.springboot.mqtt.config;
...
public class MqttConfig {
	private static final String MQTT_USERNAME = "mqtt-test";
	private static final String MQTT_PASSWORD = "mqtt-test";
	private static final String BROKER_URL = "tcp://localhost:5672";
